...
class _LoginPagePageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  //     preferences.setString('new_user_id' , id!);
  //
  //
  //     print('user-----iddddd${CUR_USERID}');
  //
  ...
  //     print('777777777777777${username}');
  ...
  Future<void> getLoginUser() async {
    ...
    print('777777777777${CUR_USERID}');
      prefs.setString('new_user_id', id.toString());
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>SetPass(
                             title: getTranslated(context, 'FORGOT_PASS_TITLE'), mobileNumber: mobile.toString(),
                          )));
            },
            child: Text(
