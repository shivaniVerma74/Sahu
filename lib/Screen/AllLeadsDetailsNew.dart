...
import '../Model/NewLeadsModel.dart';
import 'check_in_check_out_screens/check_In_screen.dart';
import 'check_in_check_out_screens/check_out_screen.dart';


class AllLeadsDetailsNew extends StatefulWidget {
  AllLeadsData? model;
  AllLeadsDetailsNew({Key? key, this.model}) : super(key: key);

  @override
  State<AllLeadsDetailsNew> createState() => _AllLeadsDetailsNewState();
}

String? latitude, longitude, state, country;

class _AllLeadsDetailsNewState extends State<AllLeadsDetailsNew> {
