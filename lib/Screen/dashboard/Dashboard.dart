...
import 'package:omega_employee_management/Screen/my_profile/MyProfile.dart';
...
class _HomePageState extends State<Dashboard> with TickerProviderStateMixin {
  ...
  AppBar _getAppBar() {
    ...
    else if (_selBottom ==2) title = getTranslated(context, 'MY_PROFILE_LBL');
            ...
            tabs: [
              ...
              Tab(
                icon: _selBottom ==1
                    ? Container(
                    height: 50,
                    child: Image.asset('assets/images/payment_logo.png',color: colors.primary,))
                    : Container(
                    height: 50,
                    child: Image.asset('assets/images/payment_logo.png',color: colors.primary,)),
                text:
