...
final Uri getFtdReport = Uri.parse(baseUrl + "get_ftd_report");
final Uri getStandingReport = Uri.parse(baseUrl + 'get_standing_report');
final Uri getPosReport = Uri.parse(baseUrl + "get_pos_report");
